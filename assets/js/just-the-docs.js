(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://stedag.io/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://stedag.io/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://stedag.io/assets/css/just-the-docs-' + theme + ".css"
      );
    };
